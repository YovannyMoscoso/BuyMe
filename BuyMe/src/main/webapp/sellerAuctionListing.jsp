...
<body>
	...
	<form action="buyerBidForm.jsp" method="post">
		Select Device to Bid On (DeviceID): <input name="deviceid" type="text" />
		<br />
	...
	<form action="alertItem.jsp" method="post">
		Want to be notified if an item is available? Type in the item: <input
			name="alertItem" type="text" /> <br /> Email: <input name="email"
			type="text" /> <br />
	...
	<br></br>
	<a href="alertItem.jsp">See Your Bids</a>
	<br></br>
